...
print(sim.describe())
# Model: iPIC3D (PIC)
# Grid: 256 × 128 × 1, dx = 0.1
# Species: electrons (q/m = -256), ions (q/m = 1)
# Steps: 0..1000
...
# Electron temperature in eV (T in energy units → divide by e)
...
gamma = lorentz_factor_from_four_velocity(data["|u|"], c=1.0)
```
